 ...
 * functions, which add @ref DEVICE_SELECTOR_DEP_FILTERS "dependent" or
 * @ref DEVICE_SELECTOR_INDEP_FILTERS "independent" filters,
 ...
 * in the @ref DEVICE_SELECTOR "device selection" mechanism.
 *
 * @{
 */
